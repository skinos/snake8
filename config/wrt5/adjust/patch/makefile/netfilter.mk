...
$(eval $(if $(and $(NF_KMOD),$(CONFIG_IPV6)),$(call nf_add,NFT_CORE,CONFIG_NFT_REJECT_IPV6, $(P_V6)nft_reject_ipv6),))
$(eval $(if $(and $(NF_KMOD),$(CONFIG_IPV6)),$(call nf_add,NFT_CORE,CONFIG_NFT_REJECT_INET, $(P_XT)nft_reject_inet),))
...
$(eval $(if $(and $(NF_KMOD),$(CONFIG_IPV6)),$(call nf_add,NFT_FIB,CONFIG_NFT_FIB_IPV6, $(P_V6)nft_fib_ipv6),))
