...
define Device/hxwlink_h721
  $(Device/dsa-migration)
  IMAGE_SIZE := 16064k
  DEVICE_VENDOR := HXWLINK
  DEVICE_MODEL := H721
  DEVICE_PACKAGES := kmod-usb3 
  SUPPORTED_DEVICES += h721
endef
TARGET_DEVICES += hxwlink_h721

define Device/lcx_v520
  $(Device/dsa-migration)
  IMAGE_SIZE := 14528k
  DEVICE_VENDOR := LCX
  DEVICE_MODEL := V520
  DEVICE_PACKAGES := kmod-mt7603 kmod-usb3 
  SUPPORTED_DEVICES += v520
endef
TARGET_DEVICES += lcx_v520

define Device/lcx_v520e
  $(Device/dsa-migration)
  IMAGE_SIZE := 14528k
  DEVICE_VENDOR := LCX
  DEVICE_MODEL := V520E
  DEVICE_PACKAGES := kmod-mt7615e kmod-mt7663-firmware-ap kmod-usb3 
  SUPPORTED_DEVICES += v520e
endef
TARGET_DEVICES += lcx_v520e

define Device/lcx_v525w
  $(Device/dsa-migration)
  IMAGE_SIZE := 14528k
  DEVICE_VENDOR := LCX
  DEVICE_MODEL := V525W
  DEVICE_PACKAGES := kmod-mt7603 kmod-usb3 
  SUPPORTED_DEVICES += v525w
endef
TARGET_DEVICES += lcx_v525w

define Device/lcx_v526
  $(Device/dsa-migration)
  IMAGE_SIZE := 14528k
  DEVICE_VENDOR := LCX
  DEVICE_MODEL := V526
  DEVICE_PACKAGES := kmod-mt7603 kmod-usb3 
  SUPPORTED_DEVICES += v526
endef
TARGET_DEVICES += lcx_v526
