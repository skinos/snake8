 ...
 *
 * On depth-1 maps, mxtalk_set_json / nested talk_to_m2talk fail (EPERM).
 *
...
/* —— set / get —— */
mxtalk_t     mxtalk_set_json( mxtalk_t t, const char *name );
...
char        *mxtalk_string_ptr( mxtalk_t t, const char *name );

int64_t     *mxtalk_set_int( mxtalk_t t, const char *name, int64_t v );
int64_t      mxtalk_int( mxtalk_t t, const char *name, int64_t def );
int64_t     *mxtalk_int_ptr( mxtalk_t t, const char *name );

boole        mxtalk_set_void( mxtalk_t t, const char *name, void *ptr );
void        *mxtalk_void( mxtalk_t t, const char *name );
...
boole        talk_to_m2talk( mxtalk_t t, const char *name, talk_t src );
