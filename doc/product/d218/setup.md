...
**为了保证路由模块能稳定高效地工作，强烈建议用户阅读以下对应文档**
...
针对不同的应用场景路由模块可提供不同的工作方式，这是工作模式的由来，**工作模式** 的配置在 **系统** 菜单下 **设备管理** 中, 路由模块常用的工作模式如下： 

**4G或5G路由器**: 通过3G/4G/5G连接互联网并为接入的客户端提供3G/4G/5G的上网服务
...
**混合**：此模式下可选择在3G/4G/5G、有线WAN口、WIFI三种模式中组合上网， 实现多种上网方式同时存在或备份或负载均衡
